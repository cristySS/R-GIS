...
const char* ssid     = "GTYV"; // "Totalplay-DFA0"; //"INFINITUM5853";// "IZZI-8F7C"; //"ARRIS-8F7C"; //
const char* password = "V1ncul4cI0n*#2021"; //"DFA051FD9NC6VK6N";//"JKcuTY9G4C"; // "C85261838F7C"; // "C85261838F7C"; //
...
// Initialize a NTPClient to get time
  ...
  timeClient.setTimeOffset(-17990); //zona horaria de CDMX
   ...
   /////////////////////////////////////////
 // Conexión con el broker MQTT        ////PASAR

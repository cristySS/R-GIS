...
const char* ssid     = "Totalplay-DFA0"; //"GTYV"; //"ARRIS-8F7C"; //"INFINITUM5853";// //"GTYV";
const char* password = "DFA051FD9NC6VK6N";//"V1ncul4cI0n*#2021"; // "C85261838F7C"; //"JKcuTY9G4C"; // //"V1ncul4cI0n*#2021";
...
bool riego1 = false, riego2 = false, riego3 = false;                                                             //indica que seccion 1,2  o 3 requiere regarse, alhaber registrado una humedad por encima de la deseda (sequedad), se define float ya que almacenara en la EEPROM 
...
String Fecha_Hora(){
  ...
  Serial.println(minu);
  int min_int = minu.toInt();                                            //convertir el String "minu" a Entero "min_int"
  //////////
  ...
  riego1 = Humedad_Sensor_1();
  riego2 = Humedad_Sensor_2();
  riego3 = Humedad_Sensor_3();
  ...
  if (hr_int == 13) {
   /* riego1 = EEPROM.get(100, valor);
    riego2 = EEPROM.get(104, valor);
    riego3 = EEPROM.get(108, valor)¨*/
    if (riego1 == true){
        ...
        Serial.print("regando seccion 1...Esto tomará:");
     ...
     if (riego2 == true){
        ...
        Serial.print("regando seccion 2...Esto tomará:");
     ...
     if (riego3 == true){
           ...
           Serial.print("regando seccion 3...Esto tomará:");
